/*Ce programme simule un pendule élastique soumis à des frottements en utilisant la méthode RK4*/
...
double l = 20.0;             //Longueur de départ
...
double a=0.47;                  //Coefficient de frottement de l'air
...
const double aDelta=0;          //Différence entre chaque simulation pour les frottements
...
int main(){
    ...
    for(int i=0;i<nEch;i++){            //Boucle pour créer le nombre d'echantillon suffisant
        ...
        l+=lDelta;teta+=tetaDelta;lptn+=lptnDelta;tetaptn+=tetaptnDelta;k+=kDelta;a+=aDelta;
